...
export default function NotFoundPage() {
  return (
    <div className="min-h-screen bg-bone flex flex-col items-center justify-center text-center px-4">
      ...
      <Link
        to="/dashboard"
        className="inline-flex items-center justify-center h-10 rounded-md bg-ink px-5 text-sm font-medium uppercase tracking-wider text-paper hover:bg-ink/90 transition-colors"
      >
        Back to Dashboard
      </Link>
    </div>
