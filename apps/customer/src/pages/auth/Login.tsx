...
export default function LoginPage() {
  ...
  const onSendOtp = (data: PhoneForm) => {
    setPhone(data.phone)
    setStep('otp')
    // TODO: call POST /api/v1/auth/send-otp
  }

  const onVerifyOtp = (_data: OtpForm) => {
    // TODO: call POST /api/v1/auth/verify-otp then navigate home
  }
